...
// DefaultClient of rest
var DefaultClient *Client

// New method creates a new rest client
func New() *Client {
...
// R creates a new rest request object, it is used form a HTTP/RESTful request
...
// SetDisableWarn method disables warning comes from `rest` client. See `Client.SetDisableWarn` for more information.
...
// SetHTTPMode method sets rest mode into HTTP. See `Client.SetMode` for more information.
func SetHTTPMode() *Client {
	return DefaultClient.SetHTTPMode()
}

// SetRESTMode method sets rest mode into RESTful. See `Client.SetMode` for more information.
...
// compatible interface implementation in the rest client.
...
// SetScheme method sets custom scheme in the rest client.
// See `Client.SetScheme` for more information.
func SetScheme(scheme string) *Client {
	return DefaultClient.SetScheme(scheme)
}

// SetCloseConnection method sets close connection value in the rest client.
