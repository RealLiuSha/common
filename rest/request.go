...
// 		rest.R().
//			SetQueryString("productId=232&template=fresh-sample&cat=rest&source=google&kw=buy a lot more")
//
...
//		rest.R().
//			SetBody(User{
//				Username: "itchenyi@gmail.com",
//				Password: "welcome2rest",
//			})
//
...
// By default rest won't set `Content-Length`. Also you have an option to enable for every
// request. See `rest.SetContentLength`
// 		rest.R().SetContentLength(true)
//
...
//
// To set the header for username "rest" and password "welcome"
// 		rest.R().SetBasicAuth("rest", "welcome")
//
// This method overrides the credentials set by method `rest.SetBasicAuth`.
//
...
//
// 		rest.R().SetAuthToken("BC594900518B4F7EAC75BD37F019E08FBC594900518B4F7EAC75BD37F019E08F")
//
// This method overrides the Auth token set by method `rest.SetAuthToken`.
//
...
// for current `Request`.
// 		resp, err := rest.R().Execute(rest.GET, "http://httpbin.org/get")
//
